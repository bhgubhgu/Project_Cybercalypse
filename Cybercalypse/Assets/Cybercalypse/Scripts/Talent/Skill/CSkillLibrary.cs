...
public class CSkillLibrary : ASkill
{
    ...
    private void RegistSkillIconToSkill()
    {
        ...
        registSkillSpriteDictionary.Add(CGameManager.instance.testSkillList[0], Null);
        registSkillSpriteDictionary.Add(CGameManager.instance.testSkillList[1], LightningSphere);
        registSkillSpriteDictionary.Add(CGameManager.instance.testSkillList[2], CrimsonStrike);
        registSkillSpriteDictionary.Add(CGameManager.instance.testSkillList[3], BlackOut);
        registSkillSpriteDictionary.Add(CGameManager.instance.testSkillList[4], FrozenContinuam);
        registSkillSpriteDictionary.Add(CGameManager.instance.testSkillList[5], FireBall);
        registSkillSpriteDictionary.Add(CGameManager.instance.testSkillList[6], MoonLightSlash);
    }
